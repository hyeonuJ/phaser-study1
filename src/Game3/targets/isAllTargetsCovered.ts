...
const isAllTargetsCovered = (
  targetsCoveredByColor: { [key: number]: number },
  boxesByColor: { [key: number]: Phaser.GameObjects.Sprite[] }
) => {
